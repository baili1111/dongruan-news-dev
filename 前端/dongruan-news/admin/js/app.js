window.app = {
    ...
    */
    ...
    portalIndexUrl: "http://www.dongruannews.com:9090/dongruan-news/portal/index.html",           // 门户首页地址
    writerLoginUrl: "http://writer.dongruannews.com:9090/dongruan-news/writer/passport.html",      // 登录页面
    writerIndexUrl: "http://writer.dongruannews.com:9090/dongruan-news/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://writer.dongruannews.com:9090/dongruan-news/writer/accountInfo.html",     // 用户信息完善页面
    
    adminCenterUrl: "http://admin.dongruannews.com:9090/dongruan-news/admin/contentReview.html",     // 运营管理平台主页
    adminLoginUrl: "http://admin.dongruannews.com:9090/dongruan-news/admin/login.html",        // admin后台登录页面
    adminIndexUrl: "http://admin.dongruannews.com:9090/dongruan-news/admin/userList.html",        // admin后台默认页面
    
    userServerUrl: "http://user.dongruannews.com:8003",        // 用户服务后端接口地址
    fsServerUrl: "http://files.dongruannews.com:8004",         // 文件服务后端接口地址
    adminServerUrl: "http://admin.dongruannews.com:8005",      // 运营管理服务后端接口地址
    articleServerUrl: "http://article.dongruannews.com:8001",      // 文章服务后端接口地址
