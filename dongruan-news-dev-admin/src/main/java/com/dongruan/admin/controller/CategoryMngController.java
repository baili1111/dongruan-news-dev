...
import com.dongruan.admin.service.CategoryService;
import com.dongruan.api.controller.BaseController;
import com.dongruan.api.controller.admin.CategoryMngControllerApi;
...
import com.dongruan.pojo.bo.SaveCategoryBO;
...
public class CategoryMngController extends BaseController implements CategoryMngControllerApi {
	...
	public GraceJSONResult getCats() {
		...
		if (StringUtils.isBlank(allCatJson)) {
			...
			redis.set(SystemConstant.REDIS_ALL_CATEGORY, JsonUtils.objectToJson(categoryList));
		} else {
